...
- Grid: 1440 wide, 12 columns, margin 80, gutter 24, content 1280.
- Section rhythm: `paddingTop` and `paddingBottom` 96 at desktop, 64 at tablet, 48 at mobile. Header block to content 48. Cards 24 apart.
- Nav: 64 high, logo leading, links at 16, one neutral CTA 36 high. The hero holds the only filled action.
- Hero: 720 high at 1440, never under 640. Headline 56 / 105 / 600 / -2, at most two lines. Subhead 20 / 150 / 400 at 560 wide or less. One filled CTA 48 high beside one neutral. Copy on columns 1 to 6, media on 7 to 12.
- Logo strip: an overline label, one row of 6 to 8 logos at 24 to 32 tall, gap 48, neutral at 0.6 opacity.
- Section header: overline, title 36 / 110 / 600 / -2 at most two lines, lead 18 / 150 at 640 wide or less.
- Feature grid: 3 cards spanning 4 columns, 2 spanning 6, 4 spanning 3, never 5. Card `cornerRadius` 16, padding 32, icon tile 40 at radius 8, `itemSpacing` 16.
- Pricing: 3 cards at 4 columns, padding 32, radius 16. Plan name 18, price 48 / 100 / 600 with TNUM. Feature rows 16 at gap 12. CTA 48 high, full width. The recommended plan carries the only filled CTA and a 1 px accent-400 stroke, never a larger card.
...
| 9 | Every nested radius equal to outer minus padding? | 5, radius |
